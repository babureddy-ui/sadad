...
{/* -----------------Features--------- */}
      ...
      <div >
      <div  className={styles.valued_option_arrow} ><Image src='/assets/valued_option_arrow.webp' fill/></div>
      ...
      <ClientSwiper/>
        ...
        <div className={styles.faq_section}>
          ...
          <div >
      <div className={styles.Queries_arrow} ><Image src='/assets/Queries_arrow.webp' fill/></div>
      ...
      <div className={styles.subscriptionSection}>
       ...
       <div style={{display:"flex", justifyContent:"space-between", width:"75%", zIndex:1, marginTop:"2rem"}}>
        <div>
          <p className={styles.footerContent_titile}>Contact</p>
          <p className={styles.footerContent}>Service@mypaga.com</p>
        ...
        <div>
          <div>
            ...
            <p className={styles.footerContent}>Company</p>
            <p className={styles.footerContent}>Careers</p>
            <p className={styles.footerContent}>Media Kit</p>
          </div> 
          <div>
        ...
        <div className={styles.poweredby_logo_section} >
          <div className={styles.footer_paga_logo}><Image src='/assets/footer_paga_logo.svg' fill/></div>
          <div className={styles.footer_CenterLine}></div>
          <div className={styles.footer_qb_logo} ><Image src='/assets/footer_qb_logo.svg' fill/></div>
        </div> <br />
        <p className={styles.all_rights}>© 2024 Doroki All rights reserved.</p>  
        </div>

        <div style={{display:"flex", gap:'1.5rem', width:"20rem" , alignItems:'center', position:'absolute',right:0, bottom:"8%" }}>
            <div  className={styles.footerIcon}><Image src='/assets/facebook.svg' fill alt="fb" /></div>
            <div className={styles.footerIcon}><Image src='/assets/Instagram.svg' fill alt="insta" /></div>
            <div className={styles.footerIcon}><Image src='/assets/Twitter.svg' fill alt="twitter" /></div>
            <div className={styles.footer_Icon}><Image src='/assets/LinkedIn.svg' fill alt="linkedin" /></div>
