      ...
      <div className={styles.subscriptionSection}>
        ...
        <div className={styles.subscribe_section}>
          <div className={styles.subscribe} >
            ...
            <p  className={styles.subscribe_txt} >
              Sadad streamlines business operations by centralising order, inventory,
       ...
       <div>
        ...
        <div>
          <div>
            <p className={styles.footerContent_titile}>About</p>
             <a href=""><p className={styles.footerContent}>Company</p></a>
            <a href=""> <p className={styles.footerContent}>Careers</p></a>
            <a href=""> <p className={styles.footerContent}>Media Kit</p></a>
          </div> 
          <div>
        ...
        <p className={styles.all_rights}>
          © {new Date().getFullYear()} Sadad All rights reserved.</p>
        </div>
